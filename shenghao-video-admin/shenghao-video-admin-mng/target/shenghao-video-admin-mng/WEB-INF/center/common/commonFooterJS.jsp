...
<%--<input type="hidden" id="apiServer" name="apiServer" value="http://192.168.117.1:8081"/>--%>
<%--<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.117.1:8080/mvc"/>--%>
<input type="hidden" id="apiServer" name="apiServer" value="http://106.14.150.87/v"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://129.204.120.143/mvc"/>
